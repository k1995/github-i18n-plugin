{
  ...
  "dict": {
    ...
    "__comments-Create a new project": "新建项目",
    ...
    "__comments-workflows": "workflows",
    "workflows": "工作流程",
    "new workflow": "新建工作流程",
    ...
    "successfully fetched and fast-forwarded from upstream": "",
